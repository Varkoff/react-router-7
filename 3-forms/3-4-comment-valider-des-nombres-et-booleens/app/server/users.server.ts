...
const db: Database = {
	users: [
		...
		{ id: 2, firstName: 'Robert', lastName: 'Durand', slug: 'robert', age: 28, active: true, },
		{ id: 3, firstName: 'John', lastName: 'Doe', slug: 'john', age: 28, active: true, },
		{ id: 4, firstName: 'Jack', lastName: 'Smith', slug: 'jack', age: 28, active: true, },
	],
	userSettings: [
